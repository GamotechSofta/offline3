  ...
  return (
    <div className="notranslate inline-flex">
      ...
      <select
        ...
        disabled={isApplying}
        className="notranslate min-h-[36px] max-w-[140px] rounded-lg border border-[#333D4D] bg-[#252D3A] px-3 py-1.5 pr-8 text-sm text-gray-200 cursor-pointer appearance-none bg-no-repeat bg-[length:18px] bg-[right_6px_center] focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:opacity-70"
        style={{
