        ...
        <Layout title="Reports">
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="bg-gray-800 rounded-lg p-6 border border-gray-700"><h3 className="text-gray-400 text-sm mb-2">Total Revenue</h3><p className="text-2xl font-bold text-green-400">₹{report.totalRevenue}</p></div>
