...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-[#1F2732] flex items-center justify-center p-4">
            <div className="bg-[#252D3A] rounded-2xl shadow-xl p-8 w-full max-w-md border-2 border-[#333D4D]">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            maxLength={10}
                            className="w-full px-4 py-3 bg-[#1F2732] border-2 border-[#333D4D] rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3 pr-12 bg-[#1F2732] border-2 border-[#333D4D] rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-primary-500 hover:bg-primary-600 text-white font-bold py-3 px-4 rounded-lg transition-all shadow-lg shadow-primary-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
