                ...
                <div className="min-w-0 max-w-full space-y-5 print:space-y-0">
                    ...
                    <div className="print:hidden">
                        <button
                            ...
                            className="text-gray-400 hover:text-primary-500 text-sm inline-flex items-center gap-1 mb-1"
                        >
                                        ...
                                        <div className="flex flex-wrap justify-between gap-x-3">
                                            ...
                                            {marketDetails.openingNumber && marketDetails.closingNumber && (
                                                <span>
                                                    ...
                                                    <span className="font-mono font-bold text-primary-600 ml-1">
                                    ...
                                    <div className="flex justify-between items-center py-0.5 text-[10px] print:text-[9px]">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <button
                                                ...
                                                className="text-primary-600 hover:text-primary-700 text-[9px] font-medium underline print:hidden disabled:opacity-50"
                                            >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 sm:mb-6">
                <div>
                    <button
                        ...
                        className="text-gray-400 hover:text-primary-500 text-sm inline-flex items-center gap-1 mb-2"
                    >
