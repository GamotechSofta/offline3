    ...
    return (
        <Layout title={t('topWinners')}>
            <div className="flex flex-wrap justify-between items-center gap-4 mb-4 sm:mb-6">
                <h1 className="text-2xl sm:text-3xl font-bold">{t('topWinnersTitle')}</h1>
                        ...
                        winners.map((winner, i) => (
                            <div key={winner._id} className="bg-white rounded-lg p-4 sm:p-6 border border-gray-200">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className={`w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold ${i === 0 ? 'bg-primary-500 text-gray-800' : i === 1 ? 'bg-gray-400 text-gray-800' : i === 2 ? 'bg-primary-600 text-gray-800' : 'bg-gray-100 text-gray-800'}`}>{i + 1}</div>
                                    <div>
