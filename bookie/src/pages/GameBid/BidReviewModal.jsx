      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .summary-row .value.primary { color: #25d366; }
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 max-h-[min(92svh,780px)] sm:max-h-[calc(100vh-48px)] flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin">
              ...
              <div ref={receiptRef} className="hidden">
                ...
                <div className="summary">
                  ...
                  <div className="summary-row"><span className="label">Total Amount</span><span className="value primary">₹{receiptData.totalAmount.toLocaleString('en-IN')}</span></div>
            ...
            <div className="px-4 py-3 border-t border-gray-200 bg-white shrink-0 flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-bold py-3 rounded-xl shadow-md active:scale-[0.99] transition-transform hover:from-primary-600 hover:to-primary-700"
              >
                Done
              </button>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 max-h-[min(90svh,720px)] sm:max-h-[calc(100vh-48px)] flex flex-col">
            ...
            {playerName && (
              <div className="px-3 sm:px-4 pt-2 shrink-0">
                <div className="bg-primary-50 border border-primary-200 rounded-lg px-3 py-2 text-sm text-primary-600 font-medium text-center">
                  Placing bet for: <span className="font-bold text-primary-700">{playerName}</span>
                </div>
              </div>
            )}
            ...
            <div className="flex-1 flex flex-col min-h-0">
              <div className="flex-1 overflow-y-auto overscroll-contain px-3 sm:px-4 pt-3 sm:pt-4 min-h-0">
                {showGameType && groupedRows ? (
                    ...
                    {Object.entries(groupedRows).map(([gameLabel, gameRows]) => (
                      <div key={gameLabel}>
                        <div className="flex items-center gap-2 mb-2">
                          <span className="text-primary-500 font-semibold text-xs uppercase tracking-wide">{gameLabel}</span>
                          <span className="text-gray-500 text-xs">({gameRows.length})</span>
                          <span className="text-primary-500 text-xs font-bold ml-auto">
                  ...
                  /* Flat list (original) */
                  <>
                    <div className="grid grid-cols-3 text-center font-semibold text-primary-500 text-[11px] sm:text-base">
              ...
              {insufficientBalance && (
                <div className="mx-3 sm:mx-4 mt-2 p-3 rounded-xl bg-primary-50 border border-primary-200 text-primary-700 text-sm shrink-0">
            ...
            <div className="px-3 sm:px-4 py-3 sm:py-4 grid grid-cols-2 gap-3 sm:gap-4 bg-white shrink-0 border-t border-gray-200">
              ...
              <button
                ...
                className="bg-gradient-to-r from-primary-500 to-primary-600 text-white font-bold py-3 rounded-xl sm:rounded-2xl shadow-md active:scale-[0.99] transition-transform hover:from-primary-600 hover:to-primary-700 disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {submitting ? (
                  <>
