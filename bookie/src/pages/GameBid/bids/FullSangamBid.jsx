                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-row items-center gap-2">
                            ...
                            <input type="text" inputMode="numeric" value={closePana}
                                ...
                                placeholder="Pana"
                                className={`flex-1 min-w-0 bg-[#1F2732] border border-[#333D4D] text-white placeholder-gray-400 rounded-full py-2.5 min-h-[40px] px-4 text-center text-sm focus:ring-2 focus:outline-none ${closePanaInvalid ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : 'focus:ring-primary-500 focus:border-primary-500'}`} />
                        </div>
                        <div className="flex flex-row items-center gap-2">
