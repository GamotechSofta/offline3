                        ...
                        <div className="bg-[#1F2732] border border-[#333D4D] rounded-2xl p-1.5 sm:p-2 overflow-hidden w-full flex-1 min-h-0">
                            <div className="overflow-x-auto md:overflow-x-hidden scrollbar-hidden h-full">
                                ...
                                >
                                    ...
                                    <div className="h-5" />
                                    {DIGITS.map((c) => (
                                        <div key={`h-${c}`} className="h-5 w-full flex items-center justify-center text-primary-500 font-bold text-[9px] md:text-xs">
                                            {c}
                                        </div>
                                    ))}
                                    ...
                                    {DIGITS.map((r) => (
                                        <React.Fragment key={`row-${r}`}>
                                            <div className="flex items-center gap-0.5 min-w-0">
                                                <div className="w-3 md:w-4 h-5 flex items-center justify-center text-primary-500 font-bold text-[9px] md:text-xs">
                                                    {r}
                                                </div>
                                                <input
                                                    type="text"
