            ...
            <div className="px-2 sm:px-4 py-3 w-full max-w-full overflow-x-hidden">
                ...
                <div className={`flex flex-col gap-2 ${embedInSingleScroll ? 'mt-2' : 'mt-5 sticky bottom-3 z-10'}`}>
                    ...
                    <button type="button" onClick={handleAddToCart} disabled={!canSubmit}
                        className={`w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white font-bold py-3.5 min-h-[52px] rounded-lg shadow-lg transition-all active:scale-[0.98] ${!canSubmit ? 'opacity-50 cursor-not-allowed' : ''}`}>
