        ...
        <Layout title={t('myPlayers')}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div className="bg-[#252D3A] rounded-xl p-4 border border-[#333D4D]">
                    ...
                    <p className="text-2xl font-bold text-primary-500 font-mono">{onlineCount}</p>
                </div>
            </div>
            ...
            <div className="mb-4 sm:mb-6">
                <div className="relative max-w-md">
                    ...
                    <input
                        ...
                        className={`w-full pl-10 py-2.5 bg-[#252D3A]/80 border border-[#333D4D] rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-all text-sm sm:text-base ${searchQuery ? 'pr-10' : 'pr-4'}`}
                    />
                    {searchQuery && (
                        <button
                            type="button"
                ...
                {loading ? (
                    ...
                    <div className="p-8 text-center text-gray-400">
                        ...
                        <button
                            type="button"
                            onClick={() => navigate('/add-user')}
                            className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary-500 hover:bg-primary-500/90 text-white font-semibold text-sm"
                        >
                            ...
                            <table className="w-full text-sm min-w-[900px]">
                                <thead className="bg-[#252D3A]">
                                    <tr>
                                        ...
                                        <th className="px-2 sm:px-3 py-2 sm:py-3 text-left text-xs font-medium text-gray-300 uppercase">{t('username')}</th>
                                        <th className="px-2 sm:px-3 py-2 sm:py-3 text-left text-xs font-medium text-gray-300 uppercase">{t('phone')}</th>
                                        <th className="px-2 sm:px-3 py-2 sm:py-3 text-left text-xs font-medium text-gray-300 uppercase">{t('balance')}</th>
                                        <th className="px-2 sm:px-3 py-2 sm:py-3 text-left text-xs font-medium text-gray-300 uppercase">{t('toGive')}</th>
                                        <th className="px-2 sm:px-3 py-2 sm:py-3 text-left text-xs font-medium text-gray-300 uppercase">{t('toTake')}</th>
                                        <th className="px-2 sm:px-3 py-2 sm:py-3 text-left text-xs font-medium text-gray-300 uppercase">{t('status')}</th>
                                        ...
                                        <th className="px-2 sm:px-3 py-2 sm:py-3 text-left text-xs font-medium text-gray-300 uppercase">{t('actions')}</th>
                                    </tr>
                                </thead>
                                        ...
                                        return (
                                            <tr key={item._id} className="hover:bg-[#1F2732]">
                                                ...
                                                <td className="px-2 sm:px-3 py-2 sm:py-3 font-medium">
                                                    <Link to={`/my-users/${item._id}`} className="text-primary-500 hover:text-primary-600 hover:underline truncate block max-w-[140px]">{item.username}</Link>
                                                </td>
                                                ...
                                                <td className="px-2 sm:px-3 py-2 sm:py-3">
                                                    <span className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-xs font-medium ${
                                                        ...
                                                        <span className={`w-2 h-2 rounded-full ${isOnline ? 'bg-green-500' : 'bg-[#1F2732]0'}`} />
                                                ...
                                                <td className="px-2 sm:px-3 py-2 sm:py-3">
                                                    <div className="flex items-center gap-1.5">
                                                        <button
                                                            ...
                                                            className="inline-flex items-center gap-1 px-2 py-1.5 rounded-lg bg-[#252D3A] hover:bg-primary-500/20 text-gray-300 text-xs font-semibold transition-colors"
                                                            title={t('viewDetails')}
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className="inline-flex items-center gap-1 px-2 py-1.5 rounded-lg bg-primary-500 hover:bg-primary-600 text-white text-xs font-semibold transition-colors"
