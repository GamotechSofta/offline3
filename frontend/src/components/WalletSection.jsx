      ...
      <div className="relative w-full max-w-lg mx-auto mb-6 sm:mb-12">
        ...
        <div className="relative bg-[#252D3A] rounded-xl min-[375px]:rounded-2xl sm:rounded-3xl px-2 min-[375px]:px-3 pt-2 pb-0 min-[375px]:pt-2.5 sm:px-6 sm:pt-5 sm:pb-0 md:px-7 md:pt-6 md:pb-0 shadow-lg border-2 border-[#333D4D] z-10 overflow-visible max-w-full">
          ...
          <div className="relative flex flex-col">
            ...
            <div className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-2 min-[375px]:gap-3 sm:gap-4 pb-2.5 sm:pb-5">
              ...
              <div className="flex items-center gap-2 min-[375px]:gap-3 sm:gap-4 flex-1 min-w-0 overflow-hidden">
                ...
                <div className="relative shrink-0">
                  <div className="w-[48px] h-[48px] min-[375px]:w-[60px] min-[375px]:h-[60px] sm:w-20 sm:h-20 md:w-[88px] md:h-[88px] bg-primary-50 rounded-xl min-[375px]:rounded-2xl sm:rounded-3xl p-2 min-[375px]:p-3 sm:p-3.5 border-2 border-primary-200 shadow-lg flex items-center justify-center">
                    <img
              ...
              <div className="flex items-center gap-2 sm:gap-3 shrink-0 ml-auto">
                ...
                <button
                  ...
                  disabled={refreshing}
                  className="w-9 h-9 min-w-[36px] min-h-[36px] sm:w-12 sm:h-12 md:w-[52px] md:h-[52px] rounded-lg min-[375px]:rounded-xl bg-primary-50 border-2 border-primary-200 flex items-center justify-center text-primary-500 hover:bg-primary-100 hover:border-primary-300 active:scale-95 disabled:opacity-50 transition-all duration-200 shadow-md"
                  aria-label="Refresh balance"
                  title="Refresh balance"
                >
                  {refreshing ? (
                    <span className="w-5 h-5 sm:w-6 sm:h-6 border-2 border-primary-300 border-t-primary-500 rounded-full animate-spin" />
                  ) : (
                ...
                <button
                  ...
                  className="group relative w-9 h-9 min-[375px]:w-10 min-[375px]:h-10 sm:w-14 sm:h-14 md:w-[56px] md:h-[56px] rounded-lg min-[375px]:rounded-xl bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center text-white overflow-hidden transition-all duration-200 hover:from-primary-600 hover:to-primary-700 active:scale-95 shadow-lg hover:shadow-xl hover:shadow-primary-500/40 shrink-0"
            ...
            <div className="flex justify-center border-t border-primary-200 relative">
              <button 
              ...
              >
                ...
                <div
                  className="w-[min(170px,calc(100vw-3rem))] sm:w-[190px] md:w-[210px] h-[32px] min-[375px]:h-[34px] sm:h-[42px] md:h-[46px] bg-gradient-to-b from-primary-500 via-primary-600 to-primary-700 flex items-center justify-center gap-2 sm:gap-3 shadow-lg"
                  style={{
