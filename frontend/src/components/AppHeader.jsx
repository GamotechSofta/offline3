      ...
      >
        <div className="flex items-center justify-between gap-2 sm:gap-2 md:gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            ...
            {user?.bookieName && (
              <span className="notranslate text-xs sm:text-sm text-gray-300 truncate max-w-[100px] sm:max-w-[160px] md:max-w-[200px] ml-0.5" title={`Created by ${user.bookieName}`}>
                Via {user.bookieName}
              </span>
            )}
          </div>

        {/* Right side: Language (translate dropdown), Wallet, Profile */}
        <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3">
          <div className="flex items-center gap-1.5 shrink-0" title="Language">
