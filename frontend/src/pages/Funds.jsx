      ...
      <div className="w-full max-w-lg md:max-w-none mx-auto md:mx-0">
        ...
        <div className="md:hidden">
          {mobileView === null ? (
            ...
            <div className="space-y-2.5">
              {items.map((item) => (
                <div
                  ...
                  className="bg-white border-2 border-primary-200 rounded-2xl p-3 flex items-center justify-between shadow-sm hover:border-primary-300 transition-colors"
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => {
                ...
                >
                  ...
                  <div className="w-8 h-8 rounded-full bg-primary-50 border border-primary-200 flex items-center justify-center text-primary-500">
            ...
            // Component view
            <div
              className={`bg-white border-2 border-primary-200 rounded-2xl shadow-sm ${
                isAddFundMobileView
        ...
        <div className="hidden md:grid md:grid-cols-[360px_1fr] md:gap-6 md:items-start">
              ...
              return (
                <button
                  ...
                  className={`w-full text-left bg-white border-2 rounded-2xl p-3 md:p-5 flex items-center justify-between shadow-sm transition-colors ${
                    active ? 'border-primary-500 bg-primary-50' : 'border-primary-200 hover:border-primary-300'
                  }`}
                >
                  ...
                  <div
                    className={`w-8 h-8 md:w-9 md:h-9 rounded-full border flex items-center justify-center ${
                      active ? 'bg-primary-500 border-primary-500 text-white' : 'bg-gray-50 border-gray-300 text-gray-500'
                    }`}
                  >
          ...
          <main className="rounded-2xl bg-white border-2 border-primary-200 shadow-sm p-6">
