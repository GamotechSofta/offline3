    ...
    <div className={`min-h-screen bg-white text-gray-800 px-3 sm:px-4 pt-3 ${hasPagination ? 'pb-[calc(100px+env(safe-area-inset-bottom,0px))]' : 'pb-[calc(7rem+env(safe-area-inset-bottom,0px))]'}`}>
      <div className="w-full max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between gap-3 mb-4">
          ...
          <button
            ...
            className="shrink-0 flex items-center gap-2 text-primary-500 hover:text-primary-600 transition-colors"
            aria-label="Filter"
            title="Filter"
          >
        ...
        <div className="space-y-4">
          {filtered.length === 0 ? (
            <div className="rounded-2xl border-2 border-primary-200 bg-white p-6 text-center text-gray-600 shadow-sm">
            ...
            return (
            <div key={`${x.id}-${r?.id ?? idx}`} className="rounded-2xl overflow-hidden border-2 border-primary-200 bg-white shadow-sm">
              <div className="bg-primary-50 px-4 py-3 text-center border-b border-primary-200">
                <div className="text-primary-500 font-extrabold tracking-wide">
                  {marketTitle.toUpperCase()} {session ? `(${session})` : ''}
                </div>
              </div>

              <div className="px-4 py-4">
                <div className="grid grid-cols-3 text-center text-primary-500 font-bold">
                  <div>Game Type</div>
      ...
      {isFilterOpen ? (
        <div className="fixed inset-0 z-[999] flex items-center justify-center px-3 sm:px-4">
          ...
          <div className="relative w-full max-w-md rounded-[28px] overflow-hidden shadow-xl border-2 border-primary-200 bg-white">
            <div className="bg-primary-500 text-white text-center py-4 text-2xl font-extrabold border-b border-primary-200">
              Filter Type
            </div>

            <div className="bg-white text-gray-800">
              <div className="px-5 py-4 max-h-[70vh] overflow-y-auto">
                <div className="text-lg font-bold text-primary-500 mb-3">By Game Type</div>
                ...
                <div className="text-lg font-bold text-primary-500 mb-3">By Winning Status</div>
                ...
                <div className="text-lg font-bold text-primary-500 mb-3">By Games</div>
                <div className="space-y-3 pb-2">
                  {marketOptions.map((name) => (
                    <label
                      key={name.key}
                      className="flex items-center gap-4 bg-primary-50 rounded-xl border-2 border-primary-200 shadow-sm px-4 py-4 hover:border-primary-300 transition-colors"
                    >
                      <input
                        type="checkbox"
                        className="w-6 h-6 accent-primary-500"
      ...
      {hasPagination ? (
        ...
        >
          <div className="mx-auto w-full max-w-[520px] pointer-events-auto">
            <div className="bg-white rounded-full border-2 border-primary-200 px-4 py-2 flex items-center justify-between shadow-md">
              <button
                type="button"
                onClick={() => {
                ...
                className="flex items-center gap-1 text-gray-700 font-semibold text-sm disabled:opacity-40 disabled:cursor-not-allowed hover:text-primary-500"
              >
              ...
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  className="w-8 h-8 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold text-sm border-2 border-primary-500"
                >
                  {currentPage}
                </button>
              </div>
