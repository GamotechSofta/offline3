      ...
      <div className="w-full max-w-xl mx-auto">
        <div className="flex items-center gap-3 pt-4 pb-3">
          <button
            ...
            className="w-10 h-10 rounded-full bg-primary-50 border border-primary-200 flex items-center justify-center hover:bg-primary-100 transition-colors shrink-0 text-gray-800"
            aria-label="Back"
          >
        ...
        {!userId && (
          <div className="mb-6 p-4 bg-primary-50 border border-primary-200 rounded-2xl text-primary-600 shadow-md text-center">
            Please login to submit a support request.
          </div>
        )}

        <div className="bg-white rounded-2xl border border-primary-200 p-4 sm:p-6 shadow-md w-full">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-gray-800 placeholder-gray-500 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition"
                disabled={!userId}
              />
            </div>
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-gray-800 placeholder-gray-500 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-y transition"
                disabled={!userId}
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full text-sm text-gray-600 file:mr-3 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-primary-500 file:text-white file:font-semibold file:cursor-pointer hover:file:bg-primary-600"
                disabled={!userId}
              />
            ...
            <button
              ...
              className="w-full px-6 py-2.5 bg-primary-500 hover:bg-primary-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold rounded-xl transition shadow-md hover:shadow-lg"
            >
