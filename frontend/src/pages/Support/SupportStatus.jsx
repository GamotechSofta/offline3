...
const statusClass = (status) => {
  const map = {
    open: 'bg-primary-100 text-primary-700 border border-primary-300',
    'in-progress': 'bg-primary-100 text-primary-700 border border-primary-300',
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 px-3 sm:px-6 md:px-8 pb-[calc(6rem+env(safe-area-inset-bottom,0px))]">
      <div className="w-full max-w-xl mx-auto">
        ...
        {!userId ? (
          <div className="p-4 bg-primary-50 border border-primary-200 rounded-2xl text-primary-600 text-center">
          ...
          <div className="space-y-3">
            {myTickets.map((t) => (
              <div
                key={t._id}
                className="bg-white rounded-2xl border border-primary-200 p-4 shadow-md hover:shadow-lg transition-shadow"
              >
                ...
                {t.adminResponse && (
                  <div className="mt-3 pt-3 border-t border-primary-200">
                    ...
                    <p className="text-sm text-primary-600 whitespace-pre-wrap">{t.adminResponse}</p>
                  </div>
                )}
              </div>
            ))}
