...
const TriplePanaBid = ({ market, title, initialSelectedDate }) => {
                    ...
                    {activeTab === 'easy' ? (
                        ...
                        <>
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
                                {tripleNumbers.map((num) => (
                                    <div key={num} className="flex items-center gap-2">
                                        <div className="w-12 h-10 bg-primary-500 border-2 border-primary-300 text-white flex items-center justify-center rounded-l-md font-bold text-sm shrink-0">
                                            {num}
                                        </div>
                                        <input
                                            type="text"
                            ...
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white font-bold py-3 rounded-md shadow-md hover:from-primary-600 hover:to-primary-700 transition-all"
                            >
                                Add to List
                            </button>
                        </>
