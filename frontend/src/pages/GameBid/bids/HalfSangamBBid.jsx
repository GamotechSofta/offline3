...
const HalfSangamBBid = ({ market, title, initialSelectedDate }) => {
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex flex-row items-center gap-2">
                                ...
                                <input
                                    ...
                                    placeholder="Ank"
                                    className="flex-1 min-w-0 bg-[#252D3A] border-2 border-[#333D4D] text-white placeholder-gray-400 rounded-full py-2.5 min-h-[40px] px-4 text-center text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:outline-none"
                                />
                            </div>
