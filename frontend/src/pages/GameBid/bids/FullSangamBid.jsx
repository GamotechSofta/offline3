            ...
            <div className="px-3 sm:px-4 py-4 md:max-w-7xl md:mx-auto">
                <div className="md:grid md:grid-cols-2 md:gap-12 md:items-start">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3 md:grid-cols-1">
                            ...
                            <button
                                ...
                                className={`w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white font-bold py-3.5 min-h-[48px] rounded-lg shadow-md transition-all ${
                                    bids.length ? 'hover:from-primary-600 hover:to-primary-700 active:scale-[0.98]' : 'opacity-50 cursor-not-allowed'
                                }`}
                            >
                                Submit Bet
                            </button>
                    ...
                    <div className="mt-10 md:mt-0">
                        <div className="grid grid-cols-[1.4fr_0.7fr_0.7fr_0.5fr] gap-2 sm:gap-3 text-center text-primary-500 font-bold text-xs sm:text-sm mb-2 px-2">
