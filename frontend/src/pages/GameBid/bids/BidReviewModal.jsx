    ...
    <div className="fixed inset-0 z-[999] flex items-center justify-center p-3 sm:p-6">
      ...
      <div className="relative w-full max-w-md sm:max-w-lg">
        {stage === 'success' ? (
          <div className="bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] overflow-hidden border-2 border-primary-200">
            ...
            <div className="px-6 pb-6">
              <button
                ...
                className="w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white font-bold py-3.5 rounded-lg shadow-md active:scale-[0.99] transition-transform hover:from-primary-600 hover:to-primary-700"
              >
                OK
              </button>
            </div>
          ...
          >
            {/* Title bar */}
            <div className="bg-primary-500 text-white px-3 sm:px-4 py-2.5 text-center text-sm sm:text-lg font-semibold shrink-0 border-b-2 border-primary-600">
            ...
            <div className="flex-1 flex flex-col min-h-0">
              ...
              <div className="px-3 sm:px-4 pt-3 sm:pt-4 shrink-0">
                <div className="rounded-2xl overflow-hidden border-2 border-primary-200 bg-primary-50">
