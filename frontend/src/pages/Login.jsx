            ...
            <div className="w-full max-w-md">
              ...
              <div className="w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-primary-500 focus:outline-none"
                  ...
                  <div className="mb-3">
                    <label className="flex items-start gap-2 cursor-pointer group">
                      <div className="relative mt-0.5">
                        ...
                        <div className={`w-4 h-4 rounded border-2 flex items-center justify-center transition-all shrink-0 ${
                          isAbove18 
                            ...
                            : 'border-gray-400 group-hover:border-primary-300 bg-white'
                        }`}>
                          {isAbove18 && (
                      ...
                      <span className="text-gray-700 text-xs leading-tight flex-1">
                        ...
                        <span className="text-primary-500 underline">Terms of Use</span> and{' '}
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-primary-500 via-primary-500 to-primary-600 text-white font-bold py-2.5 rounded-lg hover:from-primary-600 hover:via-primary-600 hover:to-primary-700 transition-all duration-200 text-sm uppercase disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-primary-500/30 hover:shadow-xl hover:shadow-primary-500/40 active:scale-[0.98]"
                  >
                    {loading ? (
              ...
              <div className="mt-4 text-center w-full">
                <p className="text-gray-600 text-xs leading-tight">
                  ...
                  <span className="text-primary-500 hover:text-primary-600 underline cursor-pointer transition-colors">Terms of Use</span>
                  {' '}and{' '}
                  <span className="text-primary-500 hover:text-primary-600 underline cursor-pointer transition-colors">Privacy Policy</span>
                </p>
              </div>
            </div>
          </div>
