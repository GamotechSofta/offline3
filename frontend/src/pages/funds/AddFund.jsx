                    ...
                    <div className="rounded-2xl bg-[#252D3A] p-0">
                        ...
                        <div className="mt-2.5 sm:mt-3 max-w-[520px] mx-auto">
                            <button
                                ...
                                className={`w-full h-9 sm:h-10 rounded-md bg-gradient-to-r from-primary-500 to-primary-600 text-white font-extrabold shadow-md hover:from-primary-600 hover:to-primary-700 transition-all ${
                ...
                <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between bg-[#252D3A] rounded-xl p-4 border-2 border-[#333D4D]">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white rounded-lg text-sm font-extrabold shadow-md"
                                >
                                    Copy
                                </button>
                            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white font-extrabold rounded-xl transition-all disabled:opacity-50 shadow-md"
                        >
