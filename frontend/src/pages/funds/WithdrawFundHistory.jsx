...
const WithdrawFundHistory = () => {
    ...
    const getStatusBadge = (status) => {
        const styles = {
            pending: 'bg-primary-100 text-primary-700 border border-primary-300',
    ...
    return (
        <div className="space-y-6">
            {/* Total Withdrawn */}
            <div className="bg-gradient-to-r from-primary-50 to-primary-100 rounded-2xl p-5 border border-primary-200">
                <p className="text-gray-600 text-sm">Total Withdrawn</p>
                <p className="text-3xl font-bold text-primary-600">₹{totalWithdrawn.toLocaleString()}</p>
            </div>
            ...
            <div className="grid grid-cols-4 gap-3">
                <div 
                    ...
                    className={`p-3 rounded-xl text-center cursor-pointer transition-colors ${
                        filter === 'all' ? 'bg-primary-500 text-white border border-primary-500' : 'bg-white text-gray-700 border border-primary-200 hover:bg-primary-50'
                    }`}
                >
                ...
                <div 
                    ...
                    className={`p-3 rounded-xl text-center cursor-pointer transition-colors ${
                        filter === 'pending' ? 'bg-primary-100 text-primary-700 border border-primary-300' : 'bg-white text-gray-700 border border-primary-200 hover:bg-primary-50'
                    }`}
                >
                ...
                <div 
                    ...
                    className={`p-3 rounded-xl text-center cursor-pointer transition-colors ${
                        filter === 'approved' ? 'bg-green-100 text-green-700 border border-green-300' : 'bg-white text-gray-700 border border-primary-200 hover:bg-primary-50'
                    }`}
                >
                ...
                <div 
                    ...
                    className={`p-3 rounded-xl text-center cursor-pointer transition-colors ${
                        filter === 'rejected' ? 'bg-red-100 text-red-700 border border-red-300' : 'bg-white text-gray-700 border border-primary-200 hover:bg-primary-50'
                    }`}
                >
