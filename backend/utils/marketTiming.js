 ...
 * - Open bets: allowed only when current time is before opening time (until openAt).
 * - Close bets: allowed until closing time (lastBetAt) only; independent of opening time.
 *
...
/**
 * Market betting window: OPEN until opening time; CLOSE until closing time (independent of opening).
