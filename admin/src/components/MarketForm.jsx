...
const MarketForm = ({ market, defaultMarketType = 'main', onClose, onSuccess, apiBaseUrl, getAuthHeaders }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/30 flex items-end sm:items-center justify-center p-0 sm:p-4 md:p-6 z-50 overflow-y-auto min-h-screen">
            <div className="bg-[#252D3A] rounded-t-2xl sm:rounded-2xl shadow-2xl w-full max-w-md border border-[#333D4D] sm:my-auto max-h-[90vh] sm:max-h-[calc(100vh-2rem)] overflow-y-auto flex flex-col">
                <div className="p-4 sm:p-6 flex-1 min-h-0 overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {market && market.marketType === 'startline' ? (
                            <>
                                <div className="rounded-lg bg-primary-500/20 border border-primary-400/50 px-3 py-2 text-sm text-primary-400">
                                ...
                                <div>
                                    ...
                                    <p className="px-3 py-2.5 bg-[#1F2732] border border-[#333D4D] rounded-lg text-white font-medium">
                                        {formData.marketName}
                                    </p>
                                </div>
                            </>
                            ...
                            <>
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            ...
                                            />
                                            <span className="text-gray-200">Main / Daily Market</span>
                                        </label>
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input
                                                type="radio"
                                                ...
                                                className="text-primary-500 focus:ring-primary-500"
                                            />
                                            <span className="text-gray-200">Startline</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-[#1F2732] border border-[#333D4D] rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 text-base"
                                ...
                                <div>
                                    ...
                                    />
                                    <p className="text-xs text-gray-400 mt-1">Optional. Shown when bookie language is Hindi.</p>
                                </div>
                            </>
                        )}
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-[1fr_auto_1fr_auto_auto] gap-1 sm:gap-2 items-center">
                                    <select
                                        ...
                                        className="w-full min-w-0 px-2 sm:px-3 py-2.5 sm:py-2.5 bg-[#1F2732] border border-[#333D4D] rounded-lg text-white focus:ring-2 focus:ring-primary-500 text-sm sm:text-base"
                                    >
                                        {HOURS_12.map((h) => (
                                    ...
                                    <select
                                        ...
                                        className="w-full min-w-[4rem] px-2 sm:px-3 py-2.5 sm:py-2.5 bg-[#1F2732] border border-[#333D4D] rounded-lg text-white focus:ring-2 focus:ring-primary-500 text-sm sm:text-base"
                                    >
                        ...
                        {formData.marketType === 'startline' && (
                            <p className="text-xs text-primary-400 bg-primary-500/20 border border-primary-400/50 rounded-lg px-3 py-2">
                        ...
                        <div>
                            <label className="block text-gray-300 text-sm font-medium mb-2">
                                Closing Time {formData.marketType === 'startline' && <span className="text-primary-400">(bet cutoff)</span>}
                            </label>
                            <div className="grid grid-cols-[1fr_auto_1fr_auto_auto] gap-1 sm:gap-2 items-center">
                                <select
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-0 rounded-lg overflow-hidden border border-[#333D4D]">
                                <input
                                    type="number"
                                    name="betClosureTime"
                                    ...
                                    placeholder="e.g. 300"
                                    inputMode="numeric"
                                    className="flex-1 min-w-[80px] sm:min-w-[100px] px-3 sm:px-4 py-2.5 sm:py-2.5 bg-[#1F2732] text-white placeholder-gray-400 text-sm sm:text-base border-0 focus:ring-2 focus:ring-primary-500 focus:ring-inset"
                                />
                                <span className="inline-flex items-center justify-center px-3 sm:px-4 py-2.5 sm:py-2.5 bg-[#252D3A] text-gray-400 text-xs sm:text-sm font-medium whitespace-nowrap">
                                    Seconds
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 pt-4 pb-4 sm:pb-0">
                            <button
                                type="button"
                                onClick={onClose}
                                className="flex-1 w-full sm:w-auto bg-[#1F2732] hover:bg-[#252D3A] text-gray-200 font-semibold py-2.5 sm:py-2 px-4 rounded-lg transition-colors"
                            >
                                Cancel
                            </button>
                            <button
                                type="submit"
                                disabled={loading}
                                className="flex-1 w-full sm:w-auto bg-primary-500 hover:bg-primary-600 text-white font-bold py-2.5 sm:py-2 px-4 rounded-lg transition-colors disabled:opacity-50"
                            >
