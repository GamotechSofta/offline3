            ...
            <div className="w-full min-w-0 px-3 sm:px-4 md:px-6 pb-6 sm:pb-8">
                            ...
                            <button
                                ...
                                className={`inline-flex items-center gap-2 px-4 py-2.5 sm:px-5 sm:py-3 rounded-xl font-semibold text-sm sm:text-base transition-all ${
                                    isActive
                                        ...
                                        : 'bg-[#1F2732] text-gray-300 hover:bg-gray-200 hover:text-white border border-[#333D4D]'
                                }`}
                            >
                ...
                <div className="flex flex-col xl:flex-row gap-4 sm:gap-6">
                    ...
                    <div className="flex-1 min-w-0 w-full">
                        {loading ? (
                            <div className="text-center py-8 sm:py-12 text-gray-400 text-xs sm:text-sm md:text-base rounded-xl border border-[#333D4D] bg-[#252D3A]">Loading markets...</div>
                        ) : markets.length === 0 ? (
                            <div className="text-center py-8 sm:py-12 text-gray-400 text-xs sm:text-sm md:text-base rounded-xl border border-[#333D4D] bg-[#252D3A]">No markets found.</div>
                        ) : (
                            <div className="overflow-x-auto -mx-2 sm:mx-0 rounded-lg sm:rounded-xl border border-[#333D4D] bg-[#252D3A] shadow-lg overscroll-x-contain touch-pan-x">
                                <table className="w-full border-collapse text-[11px] sm:text-xs md:text-sm lg:text-base min-w-[380px] sm:min-w-[520px]">
                                    <thead>
                                        <tr className="border-b border-[#333D4D]">
                                            <th className="text-left py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 font-semibold text-primary-500 bg-[#252D3A] whitespace-nowrap">Market</th>
                                            <th className="text-left py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 font-semibold text-primary-500 bg-[#252D3A] border-l border-[#333D4D] whitespace-nowrap">Timeline</th>
                                            <th className="text-left py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 font-semibold text-primary-500 bg-[#252D3A] border-l border-[#333D4D] whitespace-nowrap min-w-[4rem] sm:min-w-[5rem] md:min-w-[6.5rem]">Result</th>
                                            <th className="text-left py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 font-semibold text-primary-500 bg-[#252D3A] border-l border-[#333D4D] whitespace-nowrap">Opening</th>
                                            <th className="text-left py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 font-semibold text-primary-500 bg-[#252D3A] border-l border-[#333D4D] whitespace-nowrap">Closing</th>
                                            <th className="text-left py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 font-semibold text-primary-500 bg-[#252D3A] border-l border-[#333D4D] whitespace-nowrap min-w-[4.5rem] sm:min-w-[5.5rem] md:min-w-[6.5rem]">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {markets.map((market) => {
                                            ...
                                            return (
                                                <tr key={market._id} className={`border-b border-[#333D4D] hover:bg-[#1F2732] ${isPendingResult ? 'bg-primary-500/5' : ''}`}>
                                                    ...
                                                    <td className="py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 text-gray-300 border-l border-[#333D4D] whitespace-nowrap text-[10px] sm:text-xs md:text-sm">{timeline}</td>
                                                    <td className="py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 border-l border-[#333D4D] min-w-[4rem] sm:min-w-[5rem] md:min-w-[6.5rem]">
                                                    ...
                                                    <td className="py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 border-l border-[#333D4D]">
                                                        {hasOpen ? <span className="font-mono text-primary-500 text-[10px] sm:text-xs md:text-sm">{market.openingNumber}</span> : <span className="text-gray-400">—</span>}
                                                    </td>
                                                    <td className="py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 border-l border-[#333D4D]">
                                                        {hasClose ? <span className="font-mono text-primary-500 text-[10px] sm:text-xs md:text-sm">{market.closingNumber}</span> : <span className="text-gray-400">—</span>}
                                                    </td>
                                                    <td className="py-2 sm:py-3 px-1.5 sm:px-3 md:px-4 border-l border-[#333D4D] min-w-[4.5rem] sm:min-w-[5.5rem] md:min-w-[6.5rem]">
                                                        <button
                                                            type="button"
                                                            onClick={() => openPanelForEdit(market)}
                                                            className="px-2 sm:px-3 py-1.5 sm:py-2 bg-primary-500 hover:bg-primary-600 text-white font-semibold rounded-lg transition-colors text-xs sm:text-sm"
                                                        >
                                                            Edit Result
                                                        </button>
                                                    </td>
                    ...
                    {selectedMarket && (
                        <div className={`bg-[#252D3A] rounded-xl border border-[#333D4D] shadow-xl p-4 sm:p-5 md:p-6 ${isDirectEditMode ? 'w-full max-w-lg mx-auto' : 'w-full xl:w-[380px] xl:max-w-[400px] xl:shrink-0'}`}>
                            <h2 className="text-lg sm:text-xl font-bold text-primary-500 mb-1 border-b border-[#333D4D] pb-2 truncate" title={selectedMarket.marketName}>
                                {selectedMarket.marketName}
                            </h2>
                            {getMarketId() && (
                                <p className="text-[11px] text-gray-400 mb-3 flex flex-wrap items-center gap-x-2 gap-y-1" title="Compare with Market Detail: open same ID in URL">
                            ...
                            <div className="mb-4 sm:mb-6">
                                ...
                                <p className="text-[11px] text-gray-400 mb-2 sm:mb-3">Enter 3 digits → Check (preview) → Declare Open</p>
                                <div className="mb-2 sm:mb-3">
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g. 156"
                                        className="w-full px-3 py-2.5 sm:py-3 bg-[#1F2732] border border-[#333D4D] rounded-lg text-white text-lg sm:text-xl font-mono placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 min-h-[44px] sm:min-h-[48px] touch-manipulation"
                                        maxLength={3}
                                    />
                                </div>
                                <div className="flex gap-2 mb-2 sm:mb-3">
                                    <button
                                        ...
                                        className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3 bg-[#1F2732] hover:bg-gray-200 text-white font-semibold rounded-lg border border-[#333D4D] disabled:opacity-50 transition-colors text-sm sm:text-base"
                                ...
                                {(preview != null) && (
                                    <div className="space-y-1.5 sm:space-y-2 mb-2 sm:mb-3 rounded-lg bg-[#1F2732] border border-[#333D4D] p-2.5 sm:p-3">
                                        <div className="flex justify-between items-center gap-2">
                                            <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Bet Amount</span>
                                            <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm truncate">{formatNum(preview.totalBetAmount)}</span>
                                        </div>
                                        <div className="flex justify-between items-center gap-2">
                                            <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Bet Amount on Patti</span>
                                            <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm truncate">{formatNum(preview.totalBetAmountOnPatti)}</span>
                                        </div>
                                        <div className="flex justify-between items-center gap-2">
                                            <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Win Amount on Patti</span>
                                            <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm truncate">{formatNum(preview.totalWinAmountOnPatti)}</span>
                                        </div>
                                        <div className="flex justify-between items-center gap-2">
                                            <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total no of players</span>
                                            <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm">{formatNum(preview.noOfPlayers)}</span>
                                        </div>
                                        <div className="flex justify-between items-center gap-2">
                                            <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Players Bet on Patti</span>
                                            <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm">{formatNum(preview.totalPlayersBetOnPatti)}</span>
                                        </div>
                                        <div className="flex justify-between items-center gap-2">
                                            <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Profit</span>
                                            <span className="font-mono text-primary-500 bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm truncate">{formatNum(preview.profit)}</span>
                                        </div>
                                    </div>
                                )}
                                <button
                                    ...
                                    className="w-full px-4 py-2.5 sm:py-3 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-500 text-white font-semibold rounded-lg shadow-lg disabled:opacity-50 transition-all text-sm sm:text-base"
                            ...
                            {selectedMarket.openingNumber && /^\d{3}$/.test(selectedMarket.openingNumber) && (
                                <div className="mb-4 sm:mb-6">
                                    ...
                                    <p className="text-[11px] text-gray-400 mb-2 sm:mb-3">Enter 3 digits → Check (preview) → Declare Close</p>
                                    <div className="mb-2 sm:mb-3">
                                    ...
                                    {(previewClose != null) && (
                                        <div className="space-y-1.5 sm:space-y-2 mb-2 sm:mb-3 rounded-lg bg-[#1F2732] border border-[#333D4D] p-2.5 sm:p-3">
                                            <div className="flex justify-between items-center gap-2">
                                                <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Bet Amount</span>
                                                <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm truncate">{formatNum(previewClose.totalBetAmount)}</span>
                                            </div>
                                            <div className="flex justify-between items-center gap-2">
                                                <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Bet Amount on Patti</span>
                                                <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm truncate">{formatNum(previewClose.totalBetAmountOnPatti)}</span>
                                            </div>
                                            <div className="flex justify-between items-center gap-2">
                                                <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Win Amount on Patti</span>
                                                <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm truncate">{formatNum(previewClose.totalWinAmountOnPatti)}</span>
                                            </div>
                                            <div className="flex justify-between items-center gap-2">
                                                <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total no of players</span>
                                                <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm">{formatNum(previewClose.noOfPlayers)}</span>
                                            </div>
                                            <div className="flex justify-between items-center gap-2">
                                                <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Players Bet on Patti</span>
                                                <span className="font-mono text-white bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm">{formatNum(previewClose.totalPlayersBetOnPatti)}</span>
                                            </div>
                                            <div className="flex justify-between items-center gap-2">
                                                <span className="text-gray-400 text-xs sm:text-sm shrink-0">Total Profit</span>
                                                <span className="font-mono text-primary-500 bg-[#1F2732] px-2 py-1 rounded text-xs sm:text-sm truncate">{formatNum(previewClose.profit)}</span>
                                            </div>
                                        </div>
                                    )}
                                    <button
                            ...
                            {isDirectEditMode ? (
                                <button
                                    type="button"
                                    onClick={closePanel}
                                    className="mt-3 sm:mt-4 w-full px-4 py-2.5 sm:py-3 bg-[#1F2732] hover:bg-gray-200 text-white font-semibold rounded-lg border border-[#333D4D] transition-colors text-sm sm:text-base"
                                >
                                    Close
                                </button>
                            ) : (
